...
const filteredAdvertisements = advertisements.filter(ad => ad.isFavorite === 1);
...
<View style={{ flex: 1, alignItems: 'flex-end', justifyContent: 'center', backgroundColor: "#FFFDED"}}>
      <View style={{width:"100%", height: "100%"}}>
        ...
        <Text style={styles.subtitle}>Объявления, которые вы добавили в избранное</Text>
...
<Path d="M1.50876 14.104C0.0402142 9.16948 1.75786 3.03443 6.57136 1.36699C9.10334 0.487605 12.2279 1.22116 14.0031 3.85636C15.6769 1.12394 18.8918 0.493497 21.4211 1.36699C26.2332 3.03443 27.9604 9.16948 26.4933 14.104C24.2076 21.9257 16.2326 26 14.0031 26C11.7749 26 3.87103 22.017 1.50876 14.104Z" fill="#FF8787"/>
<Path d="M19.1186 6.9124C20.7706 7.09505 21.8039 8.50471 21.7423 10.48M1.50876 14.104C0.0402142 9.16948 1.75786 3.03443 6.57136 1.36699C9.10334 0.487605 12.2279 1.22116 14.0031 3.85636C15.6769 1.12394 18.8918 0.493497 21.4211 1.36699C26.2332 3.03443 27.9604 9.16948 26.4933 14.104C24.2076 21.9257 16.2326 26 14.0031 26C11.7749 26 3.87103 22.017 1.50876 14.104Z" stroke="white" stroke-width={2} stroke-linecap="round" stroke-linejoin="round"/>
</Svg>
