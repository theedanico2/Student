...
const Onboard2 = () => {
  ...
  return (
    ...
    <Image source={{uri: 'https://i.postimg.cc/28nxKPMX/Select.png'}} style={styles.picture}>
                                </Image>
      <Text style={styles.title}>Выбор категорий</Text>
      <Text style={styles.text}>Выберите категории товаров и услуг, 
в которых вы планируете найти исполнителей</Text>
